<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListaPedidosGerente.aspx.cs" Inherits="ListaPedidosGerente" %>
...
<body>
    ...
    <div style="background-color: #FF9933; height: 553px;">
        ...
        <asp:DropDownList ID="DDLClientes" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" style="z-index: 1; left: 163px; top: 51px; position: absolute">
        </asp:DropDownList>
        <asp:Label ID="Label3" runat="server" style="z-index: 1; left: 103px; top: 53px; position: absolute" Text="Clientes:"></asp:Label>
